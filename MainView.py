...
class MainView(Frame):
    ...
    def RotateR(self): #right rotate
        ...
        if self.im2 != None:
            ...
            self.resize(self.W2, self.H2) #resize rotated image
    ...
    def __init__(self, master=None): #initialize variables,create main frame and label
        ...
        s.theme_use('alt')
        self.Rotazione = 0
        self.master.minsize(750,70)  #minimum size of the frame to see only the bar initially
...
if __name__ == "__main__":
    mainView = MainView(); mainView.mainloop()